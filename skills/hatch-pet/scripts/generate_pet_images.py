...
def run_image_generation(
    *,
    ...
    output_json.parent.mkdir(parents=True, exist_ok=True)
    # The images/generations endpoint requires application/json (only images/edits
    # accepts multipart/form-data, since it uploads files).
    payload = {
        "model": model,
    ...
    payload_path = output_json.parent / f"{output_json.stem}.request.json"
